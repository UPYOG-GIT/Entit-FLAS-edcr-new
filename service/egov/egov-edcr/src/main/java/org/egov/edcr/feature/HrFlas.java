...
@Service
public class HrFlas extends Coverage {
	// private static final String OCCUPANCY2 = "OCCUPANCY";

	private static final Logger LOG = LogManager.getLogger(HrFlas.class);
...
//	private static final BigDecimal Forty = BigDecimal.valueOf(40);
	...
	public Plan process(Plan pl) {
		...
		System.out.println("flasRooms " + flasRooms.toString());
		System.out.println("flasToilet " + flasToilets.toString());

//		ScrutinyDetail scrutinyDetail = new ScrutinyDetail();
//		scrutinyDetail.setKey("Common_FLAS Details");
//		scrutinyDetail.setHeading("Details");
//		scrutinyDetail.addColumnHeading(1, NAME);
//		scrutinyDetail.addColumnHeading(2, LENGTH);
//		scrutinyDetail.addColumnHeading(3, BREADTH);
//		scrutinyDetail.addColumnHeading(4, MAXHEIGHT);
//		scrutinyDetail.addColumnHeading(5, MINHEIGHT);
//		scrutinyDetail.addColumnHeading(6, AVGHEIGHT);
//		scrutinyDetail.addColumnHeading(7, TOTALAREA);
//		scrutinyDetail.addColumnHeading(8, BREADTHINGSPC);

//		for (FLASRoom flasRoom : flasRooms) {
//			Map<String, String> details = new HashMap<>();
//			details.put(NAME, flasRoom.getName());
//			details.put(LENGTH, flasRoom.getLength().toString());
//			details.put(BREADTH, flasRoom.getBreadth().toString());
//			details.put(MAXHEIGHT, flasRoom.getMaxHeight().toString());
//			details.put(MINHEIGHT, flasRoom.getMinHeight().toString());
//			details.put(AVGHEIGHT, flasRoom.getAverageHeight().toString());
//			details.put(TOTALAREA, flasRoom.getTotalArea().toString());
//			details.put(BREADTHINGSPC, flasRoom.getBreathingSpace().toString());
//
