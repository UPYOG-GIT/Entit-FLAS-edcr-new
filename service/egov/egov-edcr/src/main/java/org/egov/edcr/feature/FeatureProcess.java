...
public abstract class FeatureProcess {
	...
	public static final String AVGHEIGHT = "Average Height";
	public static final String TOTALAREA = "Total Area";
	public static final String BREADTHINGSPC = "Breadthing Space";
