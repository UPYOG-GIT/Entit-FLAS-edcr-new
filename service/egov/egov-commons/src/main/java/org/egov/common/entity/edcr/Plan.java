...
//    private List<Measurement> flasRooms = new ArrayList<>();
//    private List<Measurement> flasToilet = new ArrayList<>();
//    private Measurement flasRoom = new Measurement();
//    private Measurement flasToilet = new Measurement();

	public List<FLASRoom> flasRooms = new ArrayList<>();

	public List<FLASToilet> flasToilets = new ArrayList<>();
...
//	}
	...
	public List<FLASRoom> getFlasRooms() {
		return flasRooms;
	}

	public void setFlasRooms(List<FLASRoom> flasRooms) {
		this.flasRooms = flasRooms;
	}

	public List<FLASToilet> getFlasToilets() {
		return flasToilets;
	}

	public void setFlasToilets(List<FLASToilet> flasToilets) {
		this.flasToilets = flasToilets;
	}
